...
!(function (e, t) {
  ...
  K.prototype = Object.assign(new u(), {
      ...
      for (r = 0; (c = m[r]); r++)
        'MixinCall' === c.type
          ...
          : 'VariableCall' === c.type &&
            ...
            p.resetCache());
      for (r = 0; (c = m[r]); r++)
        c.evalFirst || (m[r] = c = c.eval ? c.eval(e) : c);
      for (r = 0; (c = m[r]); r++)
        if (
          c instanceof K &&
          c.selectors &&
    ...
    matchCondition: function (e, t) {
      ...
      return (
        !!i.evaldCondition &&
        !(i.condition && !i.condition.eval(new q.Eval(t, t.frames)))
      );
    },
    resetCache: function () {
      (this._rulesets = null),
          ...
          (this._properties = this.rules
            ? this.rules.reduce(function (e, t) {
                if (t instanceof D && !0 !== t.variable) {
                  var i =
                    1 === t.name.length && t.name[0] instanceof L
                      ? t.name[0].value
                      : t.name;
    ...
    joinSelector: function (e, t, i) {
      ...
      function r(e, t) {
        var i;
        return (
          (i = new m(null, e, t.isVariable, t._index, t._fileInfo)), new F([i])
        );
      }
      function s(e, t, i, n) {
        var r, s, o;
        ...
        !(function e(t, i, l) {
          ...
          for (f = [], v = [[]], u = 0; (y = l.elements[u]); u++)
            if ('&' !== y.value) {
              var C =
                ((S = void 0),
                (x = y).value instanceof p && (S = x.value.value) instanceof F
                  ? S
                  : null);
              if (null != C) {
                a(f, v);
  ...
  var Z = function (e, t, i, n, r, s, o, a) {
    var l;
    if (
      ((this.name = e), (this.value = t instanceof u ? t : t ? new j(t) : t), i)
    ) {
      for (
        Array.isArray(i)
          ? (this.rules = i)
          : ((this.rules = [i]),
            (this.rules[0].selectors = new F(
              [],
              null,
              null,
              n,
  ...
  X.prototype = Object.assign(new u(), {
    ...
    callEval: function (e) {
      return this.ruleset.eval(
        this.frames ? new q.Eval(e, this.frames.concat(e.frames)) : e,
      );
    },
  });
    ...
    eval: function (e) {
      ...
      if (e.isMathOn(this.op)) {
        if (
          ...
          if (
            (i instanceof ie || n instanceof ie) &&
            '/' === i.op &&
            e.math === te.PARENS_DIVISION
          )
    ...
    eval: function (e) {
      ...
      if (
        (0 === i.indexOf('@@') &&
          (i =
            '@' +
            new oe(i.slice(1), this.getIndex(), this.fileInfo()).eval(e).value),
        this.evaluating)
      )
        throw {
          type: 'Name',
  ...
  he.prototype = Object.assign(new Z(), {
    ...
    bubbleSelectors: function (e) {
      e &&
        ((this.rules = [new K(k(e), [this.rules[0]])]),
        this.setParent(this.rules, this));
    },
  });
  ...
  xe.prototype = Object.assign(new u(), {
    ...
    eval: function (e) {
      ...
      for (t = 0; t < this.lookups.length; t++) {
        if (
          ((i = this.lookups[t]),
          Array.isArray(n) && (n = new K([new F()], n)),
          '' === i)
        )
          n = n.lastDeclaration();
        else if ('@' === i.charAt(0)) {
          if (
            ('@' === i.charAt(1) &&
              (i = '@' + new oe(i.substr(1)).eval(e).value),
  ...
  var Se = function (e, t, i, n, r, s, o) {
    (this.name = e || 'anonymous mixin'),
      (this.selectors = [
        new F([new m(null, e, !1, this._index, this._fileInfo)]),
      ]),
      (this.params = t),
      (this.condition = n),
      (this.variadic = r),
        ...
        for (v = (i = k(i)).length, o = 0; o < v; o++)
          if ((u = (s = i[o]) && s.name)) {
            for (c = !1, a = 0; a < p.length; a++)
              if (!n[a] && u === p[a].name) {
                (n[a] = s.value.eval(e)),
                  f.prependRule(new D(u, s.value.eval(e))),
                  (c = !0);
                break;
              }
            if (c) {
        ...
        if (!n[o]) {
          if (((s = i && i[h]), (u = p[o].name)))
            if (p[o].variadic) {
              ...
              if ((l = s && s.value))
                l = Array.isArray(l) ? new X(new K('', l)) : l.eval(e);
              else {
                if (!p[o].value)
                  throw {
                    type: 'Runtime',
    ...
    eval: function (e) {
      ...
      for (
        ...
        if ((t = e.frames[o].find(this.selector, null, d)).length > 0) {
          ...
          for (Q.reset(), p = [0, 0, 0], a = 0; a < b.length; a++)
            p[b[a].group]++;
          if (p[0] > 0) f = 2;
    ...
    _e = (function () {
      ...
      return (
        (e.prototype.evalPlugin = function (e, t, i, n, r) {
          ...
          if (
            (o || (o = a.exports),
            (o = this.validatePlugin(o, u, h)) instanceof O)
          )
            return o;
        ...
        (e.prototype.visitRuleset = function (e, t) {
          if (!e.root) {
            var i,
              ...
              l = a ? a.length : 0;
            for (i = 0; i < l; i++)
              e.rules[i] instanceof Ce.Extend &&
          ...
          entities: {
            ...
            quoted: function (e) {
              ...
              if ((t = s.$quoted()))
                return (
                  s.forget(),
                  new Ce.Quoted(t.charAt(0), t.substr(1, t.length - 2), r, i, n)
                );
              s.restore();
            },
            keyword: function () {
            ...
            arguments: function (e) {
              ...
              for (s.save(); ; ) {
                ...
                s.$char(',') ||
                  ((s.$char(';') || t) &&
                    ((t = !0),
                    (i = n.length < 1 ? n[0] : new Ce.Value(n)),
                    o.push(i),
                    (n = [])));
              }
            ...
            assignment: function () {
              ...
              if ((s.save(), (e = s.$re(/^\w+(?=\s?=)/i))))
                if (s.$char('=')) {
                  if ((t = r.entity()))
                    return s.forget(), new Ce.Assignment(e, t);
                  s.restore();
                } else s.restore();
              else s.restore();
            },
            url: function () {
              ...
              if (((s.autoCommentAbsorb = !1), s.$str('url(')))
                return (
                  ...
                  new Ce.URL(
                    null != e.value ||
                    e instanceof Ce.Variable ||
                    e instanceof Ce.Property
                      ? e
            ...
            if (
              ...
              if (n)
                return (
                  s.forget(),
                  t
                    ? new Ce.mixin.Definition(null, t, n, null, i)
                    : new Ce.DetachedRuleset(n)
                );
              s.restore();
            } else s.restore();
          },
          ...
          declaration: function () {
            ...
            if ('.' !== u && '#' !== u && '&' !== u && ':' !== u)
              if ((s.save(), (e = this.variable() || this.ruleProperty()))) {
                ...
                if (t && (this.end() || i))
                  return s.forget(), new Ce.Declaration(e, t, r, o, l, n);
                s.restore();
              } else s.restore();
          },
          ...
          permissiveValue: function (e) {
            ...
            if (!h()) {
              ...
              if (((r = h()), a.length > 0)) {
                ...
                c.push(a),
                  ' ' === s.prevChar() && c.push(new Ce.Anonymous(' ', u));
              }
              if ((s.save(), (a = s.$parseUntil(l)))) {
                ...
                for (t = 0; t < a.length; t++)
                  if (((f = a[t]), Array.isArray(f)))
                    c.push(new Ce.Quoted(f[0], f[1], !0, u, n));
                  else {
                ...
                : s.$char('(') &&
                  ...
                  s.$char(')')
                    ? t && e
                      ? r.push(
                          new Ce.Paren(
                            new Ce.Declaration(t, e, null, null, s.i, n, !0),
                          ),
                        )
                      : e
              ...
              (e = this.comment())
                ...
                : ((e = this.addition() || this.entity()) instanceof
                  ...
                  e &&
                    (i.push(e),
                    s.peek(/^\/[\/*]/) ||
                      ((t = s.$char('/')) && i.push(new Ce.Anonymous(t, n)))));
            } while (e);
  ...
  var Ze = (ze = {
    ...
    rgba: function (e, t, i, n) {
      try {
        if (e instanceof c)
          return (n = t ? Ke(t) : e.alpha), new c(e.rgb, n, 'rgba');
        var r = [e, t, i].map(function (e) {
          return (
            (i = 255),
            (t = e) instanceof ee && t.unit.is('%')
    ...
    hsla: function (e, t, i, n) {
      try {
        if (e instanceof c)
          return (n = t ? Ke(t) : e.alpha), new c(e.rgb, n, 'hsla');
        var r, s;
        function o(e) {
        ...
        for (var h = 0; h < n.length; h++) {
          ...
          v instanceof D
            ...
            v instanceof U ||
              ((i = t.rules.slice(0)),
              a &&
                i.push(new D(a, p, !1, !1, this.index, this.currentFileInfo)),
              c &&
                i.push(
                  new D(
                    c,
              ...
              l &&
                i.push(new D(l, f, !1, !1, this.index, this.currentFileInfo)),
              s.push(
                new K(
                  [new F([new m('', '&')])],
                  i,
  ...
  for (var st in rt)
    rt.hasOwnProperty(st) && (rt[st] = nt.bind(null, Math[st], rt[st]));
  ...
  var ot = function (e, t) {
    ...
    ht = {
      ...
      unit: function (e, t) {
        ...
        return (
          (t = t ? (t instanceof L ? t.value : t.toCSS()) : ''),
          new ee(e.value, t)
        );
      },
      'get-unit': function (e) {
      ...
      ((n = Object.keys(n).map(function (e) {
        ...
        return (
          t instanceof Ce.Value ||
            (t instanceof Ce.Expression || (t = new Ce.Expression([t])),
            (t = new Ce.Value([t]))),
    ...
    var u,
      ...
      h = (function (e, t, i) {
        var n = function (e, t, r) {
          ...
          if (((t.pluginManager = l), (o = new q.Parse(t)), t.rootFileInfo))
            a = t.rootFileInfo;
          else {
  ...
  if (window.less)
    for (var At in window.less)
      window.less.hasOwnProperty(At) && (_t[At] = window.less[At]);
  !(function (e, i) {
    t(i, n(e)),
    ...
    window.LESS_PLUGINS &&
      (_t.plugins = _t.plugins.concat(window.LESS_PLUGINS));
  var Mt,
    Et,
    Pt,
    Rt = (function (e, n) {
  ...
  return (
    ...
    _t.onReady &&
      ...
      _t.async ||
        ...
        Pt.styleSheet
          ? (Pt.styleSheet.cssText = Mt)
          : Pt.appendChild(document.createTextNode(Mt)),
        Et.appendChild(Pt)),
